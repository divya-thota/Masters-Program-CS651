...
// Refer to Appendix 4 of the text book for CLEEmitter information
...
public class GenFactorial {
    public static void main(String[] args) {
        ...
        //true: synthetic program => does not have a java file but is trying to generate a class file.
        ...
        // ([Ljava/lang/String;)V : Descriptor Syntax:
        // single [ = Array
        // L  + referenceType(String) + ;
        // returnType V = void
        // null: method does not throw any exceptions

        // int n = Integer.parseInt(args[0]);
        e.addNoArgInstruction(ALOAD_0); // Load reference type to stack. 0: args of stack
        e.addNoArgInstruction(ICONST_0); // Pushing 0 onto stack to get args to the 0th position
        e.addNoArgInstruction(AALOAD); // indexes the array;;'/
