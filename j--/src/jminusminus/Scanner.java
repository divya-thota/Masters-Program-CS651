    ...
    public TokenInfo getNextToken() {
        ...
        while (moreWhiteSpace) {
            ...
            if (ch == '/') {
                ...
                // Code to implement multiline comment
                else if (ch == '*') {
                    while (ch != EOFCH) {
                        nextCh();
                        if (ch == '*'){
        ...
        switch (ch) {
            ...
            case '.':
                nextCh();
                // Code for DOUBLE_LITERAL ::= "." DIGITS [ EXPONENT ] [ SUFFIX ]
                if (isDigit(ch)){
            ...
            case '9':
                ...
                // Code for LONG_LITERAL ::= INT_LITERAL ( "l" | "L" )
                if (ch == 'l' || ch == 'L'){
                    buffer.append(ch);
                    nextCh();
                    return new TokenInfo(LONG_LITERAL, buffer.toString(), line);
                }
                // code for DOUBLE_LITERAL ::= DIGITS "." [ DIGITS ] [ EXPONENT ] [ SUFFIX ]
                else if (ch == '.') {
                    buffer.append(ch);
                    nextCh();
                    while (isDigit(ch) || ch == 'e' || ch == 'E' || ch == '+' || ch == '-' || ch == 'd' || ch == 'D') {
                ...
                // Code for DOUBLE_LITERAL ::= DIGITS EXPONENT [ SUFFIX ] | DIGITS [ EXPONENT ] SUFFIX
                else if (ch == 'e' || ch == 'E') {
                    buffer.append(ch);
                    nextCh();
